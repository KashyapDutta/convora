      ...
      {crawlResult && (
        <Card className="mt-6 p-4">
          ...
          <div className="space-y-2 text-sm">
            ...
            <p>Pages Analyzed: {crawlResult.completed}</p>
            <p>Total Pages: {crawlResult.total}</p>
            <p>Analysis Credits Used: {crawlResult.creditsUsed}</p>
            <p>Data Expires: {new Date(crawlResult.expiresAt || '').toLocaleString()}</p>
            {crawlResult.data && (
              <div className="mt-4">
                <p className="font-semibold mb-2">Trend Data:</p>
